...
class ViewDetailsCL2Acitvity : AppCompatActivity() {
    ...
    private fun configureSummaryCL2(){
        ...
        text.text = "This University offers many extracurricular activities and programs for you to explore.Our campus is full of active, self-motivated individuals and we have all the connections in place to give everyone a chance to get involved and take charge.\n\n" +
